...
dataPath = '..\newall\f10d3\ALL\';
outputPath = './recognitionResult/f10d3/ALL/'
coupleCnt = 1;
interval = 100;
%factor = 1;
factor = 1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%开始处理%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fo = fopen([outputPath '每对美金特征值相差最大位置f10d3_1factor.txt'],'at');
fo1 = fopen([outputPath 'minLocation_f10d3_1factor.txt'],'at');
