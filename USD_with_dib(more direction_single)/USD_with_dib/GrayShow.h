...
public:
	...
	//vector<BYTE**>  split(BYTE** ImageArray,int ImageWidth,int ImageHeight,int splitWidth);	//将图片分竖条
	...
	vector<BYTE**>  splitAndMove(BYTE** ImageArray,int ImageWidth,int ImageHeight,int splitWidth,int Move);
